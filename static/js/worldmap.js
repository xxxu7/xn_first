...
function get_data()
{
    ...
    req.onreadystatechange = function () {
        if (req.readyState == 4 && req.status == 200) {
            ...
            console.log(result);
            draw_worldmap(result)
        }

    }

    req.open("GET", 'http://127.0.0.1:5001/worldmap');
    req.send();
...
option = {
    ...
    visualMap: {
        ...
        inRange: {
            ...
            color: ['#8fa2d2', '#cf9a4a', '#68cbb5', '#77c4d7', '#8fd294', '#4b69dc'] // 图元的颜色
        }
    },
    series: [
        {
...
myChart.on('click', function (params) {
    ...
    let params1 = new URLSearchParams({ country: params.data['name'], n: 500 }).toString();
    req.open("GET", 'http://127.0.0.1:5001/top-in-country?' + params1);
    req.send();
});
}